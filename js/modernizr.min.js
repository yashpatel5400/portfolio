 ...
 * https://modernizr.com/download/?-csscalc-svgclippaths-setclasses !*/
! function(e, n, t) {
    function s(e, n) {
        return typeof e === n
    }
    ...
    function a() {
        ...
        for (var f in r)
            if (r.hasOwnProperty(f)) {
                ...
                for (a = s(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) i = e[o], c = i.split("."), 1 === c.length ? Modernizr[c[0]] = a : (!Modernizr[c[0]] || Modernizr[c[0]] instanceof Boolean || (Modernizr[c[0]] = new Boolean(Modernizr[c[0]])), Modernizr[c[0]][c[1]] = a), l.push((a ? "" : "no-") + c.join("-"))
            }
    }
    ...
    c._prefixes = m, Modernizr.addTest("csscalc", function() {
        var e = "width:",
            n = "calc(10px);",
            t = i("a");
        return t.style.cssText = e + m.join(n + e), !!t.style.length
    }), a(), o(l), delete c.addTest, delete c.addAsyncTest;
